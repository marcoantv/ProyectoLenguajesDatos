...
$consultaSQL = " begin PAQUETE_DE_PRODUCTOS.obtenerInformacionDetalleProducto(:idProductoP,:nombreProducto,:descripcionProducto,:precioProducto,
:tipoTalla,:tipoCategoria,:imagen); end;";
...
oci_bind_by_name($stid, ":tipoTalla", $tipoTalla, 64);
oci_bind_by_name($stid, ":tipoCategoria", $tipoCategoria, 64);
                    ...
                    <div class="col-lg-12">
                        <div class="product_img_slide owl-carousel">
                            <div class="single_product_img">
                                <img height="700px" src="data:image/jpg;base64,<?php echo base64_encode($imagenProducto->load()) ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="single_product_text text-center">
                            ...
                            <div style="text-align:justify">                        
                                <h4>Descripcion: <?php echo $descripcionProducto ?> </h4>
                                <h4>Categoria: <?php echo $tipoCategoria ?> </h4>
                                <h4>Talla: <?php echo $tipoTalla ?> </h4>
                            </div>
                            <div class="card_area">
                                <div class="product_count_area">
                                    <h1><?php echo utf8_encode($precioProducto) ?> </h1>
                                </div>
                                <div class="add_to_cart">
                                    <a href="cart.php?idProducto=<?php echo $idProducto ?> " class="btn_3">Añadir al carrito</a>
                                </div>
                            </div>
                        </div>
                    </div>
