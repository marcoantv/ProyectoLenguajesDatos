...
$consultaSQL = "begin paquete_de_productos.obtenerCamisasRecientes(:productos); end;";
...
$consultaSQL = "begin paquete_de_productos.obtenerCamisasPorPrecionDescendiente(:productos); end;";
$stid = oci_parse($conexion, $consultaSQL);
