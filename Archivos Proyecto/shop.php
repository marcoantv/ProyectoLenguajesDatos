...
$consultaSQL = "begin paquete_de_productos.obtenerProductosRecientes(:productos); end;";
...
$consultaSQL = "begin paquete_de_productos.obtenerTodosLosProductosPorPrecionDescendiente(:productos); end;";
$stid = oci_parse($conexion, $consultaSQL);
