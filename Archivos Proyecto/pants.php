...
$consultaSQL = "begin paquete_de_productos.obtenerPantSRecientes(:productos); end;";
...
$consultaSQL = "begin paquete_de_productos.obtenerPantSPorPrecionDescendiente(:productos); end;";
$stid = oci_parse($conexion, $consultaSQL);
