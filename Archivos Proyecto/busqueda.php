...
$productoABuscar = $_GET['articulo'];

$conexion = abrirConexion();

$cursorProductosEncontrados = oci_new_cursor($conexion);

$consultaSQL = "begin paquete_de_productos.buscarArticuloPorRegex(:articuloABuscar,:productos); end;";
$stid = oci_parse($conexion, $consultaSQL);
oci_bind_by_name($stid,":articuloABuscar",$productoABuscar);
oci_bind_by_name($stid, ":productos", $cursorProductosEncontrados, -1, OCI_B_CURSOR);
oci_execute($stid);
oci_execute($cursorProductosEncontrados);
            ...
            <div class="container">
                    ...
                    <div class="properties__button">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"> Popular </a>
                            </div>
                        </nav>
                        <!--End Nav Button  -->
                    </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        while ($fila = oci_fetch_array($cursorProductosEncontrados)) {
...
oci_free_statement($cursorProductosEncontrados);
