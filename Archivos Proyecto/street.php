                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            ...
                            <ul id="navigation">  
                                    ...
                                    <li class="hot"><a href="#">Productos</a>
                                        <ul class="submenu">
                                    ...
                                    <li><a href="#">Compras</a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="confirmation.php">Confirmacion de pago</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
                    ...
                    <div class="properties__button">
                        ...
                        <nav>                                                      
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"> De Mayor a Menor</a>
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"> Mas Populares </a>
                            </div>
                        </nav>
                        <!--End Nav Button  -->
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row mb-5">
                            <?php 
                                ...
                                $resultado = $conexion ->query("select * from productosS order by id desc limit 10") or die($conexion-> error);
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <figure class="block-4-image">
                                        <a href="street.php">
                                        <img src="assets/img/gallery/street/<?php echo $fila[imagen];?>" alt="<?php echo $fila[nombre];?>" class="img-fluid"></a>
                                    <figure>
                                    <div class="block-4-text p-4">
                                        <h3><a href="street.php"><?php echo $fila['nombre']; ?></a></h3>
                                        <p class="mb-0"><?php echo $fila['descripcion']; ?></p>
                                        <p class="text-primary font-weigth-bold">$<?php echo $fila['precio']; ?></p>
                                    </div>
                                </div>
                            </div>
                                <?php } ?>
