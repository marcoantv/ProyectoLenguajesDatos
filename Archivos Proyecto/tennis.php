...
$cursorProductosPorResenia = oci_new_cursor($conexion);

$consultaSQL = "begin PAQUETE_DE_PRODUCTOS.obtenerTenisRecientes(:productos); end;";
...
$consultaSQL = "begin PAQUETE_DE_PRODUCTOS.obtenerTenisPorPrecionDescendiente(:productos); end;";
$stid = oci_parse($conexion, $consultaSQL);
...
while ($fila = oci_fetch_array($cursorProductosPorResenia)) {
...
oci_free_statement($cursorTodosProductos);
oci_free_statement($cursorProductosOrdenadosPorPrecio);
