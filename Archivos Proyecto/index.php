                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <form method='POST'>
                                <li><button type='submit' name='cerrarSesion' 
                                style='color:black; border: none; background-color:white;'>Cerrar Sesion</a></li>
                                </form>
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">Selecciona tu estilo</h1>
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">Satisfacción garantizada. Compre los últimos productos Street Nueva York en el mercado de algunos consignadores de todo Estados Unidos. La mejor calidad, se uno mas de nuestros clientes de todo el mundo.</p>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="street.php" class="btn hero-btn">Comprar Ahora</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="assets/img/haku.ico" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-slider slider-height d-flex align-items-center slide-bg">
                    <div class="container">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="assets/img/hoodiegirl.png" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-between padding-130">
                    <div class="col-lg-5 col-md-6">
                        <div class="watch-details mb-40">
                            <h2>Hoodie de eleccion</h2>
                            <p>¡En HAKU, creemos que los hoodies son la pieza de ropa más épica jamás creada! Si bien los hoodies han existido durante años, y nosotros contamos con las nuevas colecciones de champion.</p>
                            <a href="shop.php" class="btn">Ver Productos</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="assets/img/hoodiechampion.png" alt="">
                        </div>
                    </div>
                </div>
